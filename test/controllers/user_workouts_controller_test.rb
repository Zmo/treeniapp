...
class UserWorkoutsControllerTest < ActionController::TestCase
  ...
  test "should create user_workout" do
    assert_difference('UserWorkout.count') do
      post :create, user_workout: { title: @user_workout.title, type: @user_workout.type, user_id: @user_workout.user_id }
    end
  ...
  test "should update user_workout" do
    patch :update, id: @user_workout, user_workout: { title: @user_workout.title, type: @user_workout.type, user_id: @user_workout.user_id }
    assert_redirected_to user_workout_path(assigns(:user_workout))
  end
