...
class WorkoutsControllerTest < ActionController::TestCase
  ...
  test "should create workout" do
    assert_difference('Workout.count') do
      post :create, workout: { muscles: @workout.muscles, person_id: @workout.person_id, title: @workout.title }
    end
  ...
  test "should update workout" do
    patch :update, id: @workout, workout: { muscles: @workout.muscles, person_id: @workout.person_id, title: @workout.title }
    assert_redirected_to workout_path(assigns(:workout))
  end
